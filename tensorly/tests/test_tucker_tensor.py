...
def test_tucker_to_tensor_with_partial_modes():
    ...
    true_res = np.array(
        [
            [[120.0, 456.0, 792.0], [400.0, 1472.0, 2544.0], [680.0, 2488.0, 4296.0]],
            [[126.0, 486.0, 846.0], [422.0, 1582.0, 2742.0], [718.0, 2678.0, 4638.0]],
            [[132.0, 516.0, 900.0], [444.0, 1692.0, 2940.0], [756.0, 2868.0, 4980.0]],
        ]
    )
