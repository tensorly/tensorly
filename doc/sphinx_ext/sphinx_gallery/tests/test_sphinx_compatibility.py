...
def test_status_iterator(fakesphinxapp):
    for _ in sphinx_compatibility._app_status_iterator([1, 2, 3], "summary", length=3):
        pass
...
def test_status_iterator_color(fakesphinxapp):
    for _ in sphinx_compatibility._app_status_iterator(
        [1, 2, 3], "summary", color="green", length=3
    ):
        pass
